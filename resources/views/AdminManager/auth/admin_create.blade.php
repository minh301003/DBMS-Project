    ...
    <div class="container p-">
        ...
        <form method="POST" action="/admin/admins/store" enctype="multipart/form-data">
          ...
          <div class="form-group">Email:</label>
            <input type="" class="form-control" id="email" placeholder="Thêm email" name="email">
          </div>
          <div class="form-group">
            <label for="password">Mật khẩu:</label>
            <input type="password" class="form-control" id="password" placeholder="Thêm mật khẩu" name="password">
          </div>
          <div class="form-group">
